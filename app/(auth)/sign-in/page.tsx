...
export default function SignInPage() {
  ...
  const mutation = useMutation({
    ...
    onSuccess: async (user) => {
      // Seed the me cache with the fresh user so every useMe() consumer
      // flips to authed instantly — no refresh required.
      qc.setQueryData(["me"], user);
      // Drop any cached anonymous data so the next /dashboard render
      // refetches with the new session cookie attached.
